...
get_last_info(User, Server) ->
    ...
    MLS = lists:member(mod_last_sdb, gen_mod:loaded_modules(Server)),
    case {ML, MLO, MLS} of
	{true, _, _} -> mod_last:get_last_info(User, Server);
	{false, true, _} -> mod_last_odbc:get_last_info(User, Server);
	{false, false, true} -> mod_last_sdb:get_last_info(User, Server);
